...
Keep the SDK aligned with implemented FreeAgent API behavior, with a repeatable process for detecting and fixing drift.
...
2. SDK code for implemented behavior.
3. SDK tests for expected contract behavior.
...
3. Compare service behavior, pagination, and payload guards.
...
| Test gaps for implemented behavior | Medium | Add tests before merge |
...
3. Add or update tests to lock in intentional behavior.
4. Ensure sample app and docs reflect the chosen behavior.
