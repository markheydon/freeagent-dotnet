...
| [/categories/detail](https://localhost:5001/categories/detail) | `GetCategoryAsync()`, `CreateIncomeCategoryAsync()`, `UpdateIncomeCategoryAsync()`, `DeleteCategoryAsync()` | CRUD probes, income fixture, progress bar |
