...
| [/categories/detail](https://localhost:5001/categories/detail) | All `Create*CategoryAsync` / `Update*CategoryAsync` / `DeleteCategoryAsync` via write-variant selector | CRUD probes, all documented write variants, progress bar |
