...
/// <summary>
/// Estimate VAT status values for reporting purposes.
/// </summary>
[JsonConverter(typeof(JsonStringEnumMemberNameCompatibleConverter<EstimateEcStatus>))]
public enum EstimateEcStatus
{
