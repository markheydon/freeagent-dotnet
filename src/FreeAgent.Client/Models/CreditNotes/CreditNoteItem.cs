...
/// <summary>
/// Represents a line item on a FreeAgent credit note.
/// </summary>
public sealed class CreditNoteItem
{
    ...
    /// <summary>
    /// Position in the credit note, starting at 1.
    /// </summary>
    ...
    /// <summary>
    /// Whether the line item suffers a CIS deduction.
    /// </summary>
    [JsonPropertyName("suffers_cis_deduction")]
    public bool? SuffersCisDeduction { get; set; }
    ...
    /// <summary>
    /// Credit note item identifier used when updating or deleting an existing line item.
    /// </summary>
    [JsonIgnore]
    public long? ItemId
    {
