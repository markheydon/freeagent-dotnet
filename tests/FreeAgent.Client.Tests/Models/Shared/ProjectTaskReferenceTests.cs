...
public class ProjectTaskReferenceTests
{
    [Fact]
    public void ForEnvironment_Production_BuildsExpectedUri()
    {
        var reference = ProjectTaskReference.ForEnvironment(FreeAgentEnvironment.Production, 12);
    ...
    {
        var reference = ProjectTaskReference.Parse("https://api.sandbox.freeagent.com/v2/tasks/3");
    ...
    public void Parse_WrongResourceType_Throws()
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            ProjectTaskReference.Parse("https://api.freeagent.com/v2/projects/12"));
